...
func home(w http.ResponseWriter, r *http.Request) {
	...
	requestLog.Info("A message with a few structured properties")
	requestLog.Warn("Oh no, an intentional warning!")
	...
	if err := fail(); err != nil {
		...
		requestLog.Errorf("Damn, it failed (intentionally): %v\n%v", err, string(debug.Stack()))
	}
